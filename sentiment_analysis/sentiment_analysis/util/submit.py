...
RELEVANT_FOLDERS = ["models", "autoencoder"]
...
def submit_exercise(
    zip_output_filename="submission", data_path=".", relevant_folders=RELEVANT_FOLDERS
):
    ...
    """
    # Notebook filenames
    notebooks_filenames = [x for x in os.listdir(data_path) if x.endswith(".ipynb")]
    # Existing relevant folders
    relevant_folders = [x for x in os.listdir(data_path) if x in relevant_folders]
    print(
    ...
    print(
        "Zipping successful! Zip is stored under: {}".format(
